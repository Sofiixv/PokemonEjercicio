...
public class App {
            ...
            switch (opcion) {
                case 1:
                    ...
                    if (pokemonsDisponibles) {
                        darMasPokemons();
                        pokemon1.setNombre(nombrePokemon1);
                        pokemon1.setTipo(tipoPokemon1);
                        pokemon1.setNivel(nivelPokemon1);
                        pokemon1.setAtaque(ataquePokemon1);
                        pokemon2.setNombre(nombrePokemon2);
                        pokemon2.setTipo(tipoPokemon2);
                        pokemon2.setNivel(nivelPokemon2);
                        pokemon2.setAtaque(ataquePokemon2);
                    } else {
    ...
    public static void darPokemon1() {
        ...
        System.out.println("Ahora dime el tipo del pokemon (agua, planta, tierra, fuego, hielo)");
        System.out.print("> ");
        ...
        System.out.println("Por ultimo dime su nivel (1-100)");
        while (!nivelCorrecto) {
